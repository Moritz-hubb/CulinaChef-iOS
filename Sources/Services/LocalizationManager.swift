...
extension String {
    ...
    func localized(replacing replacements: [String: String]) -> String {
...
enum L {
    ...
    static let recipes_renameMenuHeadline = "recipes.renameMenuHeadline"
    static let recipes_renameMenuFailed = "recipes.renameMenuFailed"
    ...
    static let intro_slide1 = "intro.slide1"
    static let intro_slide2 = "intro.slide2"
    static let intro_slide3 = "intro.slide3"
    static let intro_slide4 = "intro.slide4"
    static let intro_notificationsTitle = "intro.notificationsTitle"
    static let intro_notificationsAllow = "intro.notificationsAllow"
    static let intro_notificationsLater = "intro.notificationsLater"
    static let onboarding_feature_ai = "onboarding.feature.ai"
    static let onboarding_feature_ai_desc = "onboarding.feature.ai_desc"
    static let onboarding_feature_nutrition = "onboarding.feature.nutrition"
    static let onboarding_feature_nutrition_desc = "onboarding.feature.nutrition_desc"
    static let onboarding_feature_personalized = "onboarding.feature.personalized"
    static let onboarding_feature_personalized_desc = "onboarding.feature.personalized_desc"
    ...
    static let subscriptionRestoreSuccess = "subscription.restoreSuccess"
    static let subscriptionRestoreSuccessMessage = "subscription.restoreSuccessMessage"
    static let subscriptionRestoreNoPurchases = "subscription.restoreNoPurchases"
    static let subscriptionRestoreNoPurchasesMessage = "subscription.restoreNoPurchasesMessage"
    ...
    static let subscriptionSubscribeToPremium = "subscription.subscribeToPremium"
    static let subscriptionCancelSubscription = "subscription.cancelSubscription"
    static let subscriptionPremiumWeekly = "subscription.premiumWeekly"
    static let subscriptionPremiumMonthly = "subscription.premiumMonthly"
    ...
    static let chat_recipeCreated = "chat.recipeCreated"
    static let chat_openCreatedRecipe = "chat.openCreatedRecipe"
    ...
    static let chat_suggestion_hint = "chat.suggestion.hint"
    static let chat_suggestion_send = "chat.suggestion.send"
    static let chat_offTopicReply = "chat.offTopicReply"
    ...
    static let onboarding_username_title = "onboarding.username.title"
    static let onboarding_username_subtitle = "onboarding.username.subtitle"
    static let onboarding_username_label = "onboarding.username.label"
    static let onboarding_username_placeholder = "onboarding.username.placeholder"
    static let onboarding_greeting_title = "onboarding.greeting.title"
    static let onboarding_greeting_message = "onboarding.greeting.message"
    static let onboarding_greeting_fallback = "onboarding.greeting.fallback"
    ...
    static let recipe_qaSystemIntro = "recipe.qaSystemIntro"
    static let recipe_qaKeepShort = "recipe.qaKeepShort"
    static let recipe_qaOffTopic = "recipe.qaOffTopic"
    static let recipe_qaDataLabel = "recipe.qaDataLabel"
    static let recipe_qaCurrentStep = "recipe.qaCurrentStep"
    static let recipe_qaOverview = "recipe.qaOverview"
    ...
    static let recipe_nährwerte_export_einleitung = "recipe.nährwerte_export_einleitung"
    ...
    static let recipe_revise_tab_chat = "recipe.revise.tabChat"
    ...
    static let recipe_revise_goal_lactose_free = "recipe.revise.goalLactoseFree"
    static let recipe_revise_goal_low_carb = "recipe.revise.goalLowCarb"
    static let recipe_revise_goal_low_salt = "recipe.revise.goalLowSalt"
    static let recipe_revise_free_text_placeholder = "recipe.revise.freeTextPlaceholder"
    static let recipe_revise_button = "recipe.revise.button"
    static let recipe_revise_loading = "recipe.revise.loading"
    static let recipe_revise_need_full_recipe = "recipe.revise.needFullRecipe"
    static let recipe_revise_need_goal_or_text = "recipe.revise.needGoalOrText"
    static let recipe_revise_badge = "recipe.revise.badge"
    ...
    static let import_social_extra_label = "import.social_extra_label"
    static let import_social_extra_hint = "import.social_extra_hint"
    static let import_social_extra_placeholder = "import.social_extra_placeholder"
    static let import_social_submit = "import.social_submit"
    static let import_social_metadata_heading = "import.social_metadata_heading"
    static let import_social_metadata_hint = "import.social_metadata_hint"
    static let import_social_metadata_platform = "import.social_metadata_platform"
    static let import_social_metadata_author = "import.social_metadata_author"
    static let import_social_metadata_title = "import.social_metadata_title"
    static let import_social_metadata_description = "import.social_metadata_description"
    static let import_social_metadata_snippet = "import.social_metadata_snippet"
    static let import_social_metadata_reload = "import.social_metadata_reload"
    ...
    static let import_social_insufficient_info = "import.social_insufficient_info"
    static let import_social_processing = "import.social_processing"
    ...
    static let tag_pescetarian = "tag.pescetarian"
    ...
    static let tag_halal = "tag.halal"
    static let tag_kosher = "tag.kosher"
    ...
    static let settings_exportBody = "settings.exportBody"
    static let settings_exportButton = "settings.exportButton"
    static let settings_exportQuestions = "settings.exportQuestions"
    static let a11y_decreaseCount = "a11y.decreaseCount"
    static let a11y_increaseCount = "a11y.increaseCount"
    static let a11y_openMealPlan = "a11y.openMealPlan"
    ...
    // MARK: - Accessibility
    static let a11y_enterAllergy = "a11y.enterAllergy"
    static let a11y_addAllergy = "a11y.addAllergy"
    static let a11y_addAllergyHint = "a11y.addAllergyHint"
    static let a11y_removeItem = "a11y.removeItem"
    static let a11y_removeAllergyHint = "a11y.removeAllergyHint"
    static let a11y_removeDislikeHint = "a11y.removeDislikeHint"
    static let a11y_startOnboarding = "a11y.startOnboarding"
    static let a11y_goToNextStep = "a11y.goToNextStep"
    static let a11y_goToPreviousStep = "a11y.goToPreviousStep"
    static let a11y_currentlySelected = "a11y.currentlySelected"
    static let a11y_selectLanguage = "a11y.selectLanguage"
    static let a11y_hidePassword = "a11y.hidePassword"
    static let a11y_showPassword = "a11y.showPassword"
    static let a11y_signInWithEmailHint = "a11y.signInWithEmailHint"
    static let a11y_openPasswordReset = "a11y.openPasswordReset"
    static let a11y_switchToTab = "a11y.switchToTab"

    // MARK: - Auth errors (UI)
    static let error_appleSignInSimulator = "error.appleSignInSimulator"
    static let error_appleSignInUseEmail = "error.appleSignInUseEmail"
    static let error_signInFailed = "error.signInFailed"

    // MARK: - Timer notifications
    static let timer_expiredTitle = "timer.expiredTitle"
    static let timer_expiredBody = "timer.expiredBody"
    static let trial_endingTomorrowTitle = "trial.endingTomorrowTitle"
    static let trial_endingTomorrowBody = "trial.endingTomorrowBody"

    static let a11y_openSignUp = "a11y.openSignUp"
    static let a11y_openSignIn = "a11y.openSignIn"
    static let a11y_openTerms = "a11y.openTerms"
    ...
    static let a11y_openSubscription = "a11y.openSubscription"
    static let a11y_openDietarySettings = "a11y.openDietarySettings"
    static let a11y_openSubscriptionPicker = "a11y.openSubscriptionPicker"
    static let a11y_closeSignIn = "a11y.closeSignIn"
    static let a11y_closePasswordReset = "a11y.closePasswordReset"
    static let a11y_closeDietary = "a11y.closeDietary"
    static let a11y_closeRecipe = "a11y.closeRecipe"
    static let a11y_closePaywall = "a11y.closePaywall"
    static let a11y_closePaywallContinueFree = "a11y.closePaywallContinueFree"
    static let a11y_signOut = "a11y.signOut"
    static let a11y_deleteAccount = "a11y.deleteAccount"
    static let a11y_fairUsePolicy = "a11y.fairUsePolicy"
    static let a11y_acceptFairUse = "a11y.acceptFairUse"
    static let a11y_fairUseAccepted = "a11y.fairUseAccepted"
    static let a11y_enterDislike = "a11y.enterDislike"
    static let a11y_addDislikeHint = "a11y.addDislikeHint"
    static let a11y_addShoppingItem = "a11y.addShoppingItem"
    static let a11y_clearCompleted = "a11y.clearCompleted"
    static let a11y_clearAllShopping = "a11y.clearAllShopping"
    static let a11y_removeShoppingItem = "a11y.removeShoppingItem"
    static let a11y_shoppingCategoryCount = "a11y.shoppingCategoryCount"
    static let a11y_collapseCategory = "a11y.collapseCategory"
    static let a11y_expandCategory = "a11y.expandCategory"
    static let a11y_deleteNamedItem = "a11y.deleteNamedItem"
    ...
    static let a11y_aiAssistantHint = "a11y.aiAssistantHint"
    static let a11y_hideTimers = "a11y.hideTimers"
    static let a11y_activeTimers = "a11y.activeTimers"
    static let a11y_hideTimersHint = "a11y.hideTimersHint"
    static let a11y_showTimersHint = "a11y.showTimersHint"
    static let a11y_unlockUnlimited = "a11y.unlockUnlimited"
    static let a11y_generateRecipeFromInputs = "a11y.generateRecipeFromInputs"
    static let a11y_generateRecipeFromIngredients = "a11y.generateRecipeFromIngredients"
    static let a11y_servingsCount = "a11y.servingsCount"
    static let a11y_cookingTimeMinutes = "a11y.cookingTimeMinutes"
    static let a11y_enterIngredient = "a11y.enterIngredient"
    static let a11y_enterIngredientHint = "a11y.enterIngredientHint"
    static let a11y_addIngredient = "a11y.addIngredient"
    static let a11y_addIngredientHint = "a11y.addIngredientHint"
    static let a11y_removeIngredient = "a11y.removeIngredient"
    static let a11y_removeNamedFromList = "a11y.removeNamedFromList"
    static let a11y_removeImage = "a11y.removeImage"
    static let a11y_removeAttachedImage = "a11y.removeAttachedImage"
    static let a11y_removeThisImage = "a11y.removeThisImage"
    static let a11y_addPhotoToUpload = "a11y.addPhotoToUpload"
    static let a11y_retryLastMessage = "a11y.retryLastMessage"
    static let a11y_createRecipeFor = "a11y.createRecipeFor"
    static let a11y_createMenu = "a11y.createMenu"
    static let a11y_menuCreated = "a11y.menuCreated"
    static let a11y_creatingMenu = "a11y.creatingMenu"
    static let a11y_createMenuFromRecipes = "a11y.createMenuFromRecipes"
    static let a11y_searchHint = "a11y.searchHint"
    static let a11y_clearSearch = "a11y.clearSearch"
    static let a11y_clearSearchHint = "a11y.clearSearchHint"
    static let a11y_selectThisReason = "a11y.selectThisReason"
    static let a11y_additionalDetails = "a11y.additionalDetails"
    static let a11y_additionalDetailsHint = "a11y.additionalDetailsHint"
    static let a11y_submitReport = "a11y.submitReport"
    static let a11y_fullPrivacyPolicy = "a11y.fullPrivacyPolicy"
    static let a11y_openFullPrivacy = "a11y.openFullPrivacy"
    static let a11y_acceptAndContinue = "a11y.acceptAndContinue"
    static let a11y_decline = "a11y.decline"
    static let a11y_acceptConsentHint = "a11y.acceptConsentHint"
    static let a11y_declineConsentHint = "a11y.declineConsentHint"
    static let a11y_subscribeUnlimitedHint = "a11y.subscribeUnlimitedHint"
    static let a11y_restorePurchasesHint = "a11y.restorePurchasesHint"
    static let a11y_setNewPassword = "a11y.setNewPassword"
    static let validation_emailInvalid = "validation.emailInvalid"
    static let validation_passwordTooShort = "validation.passwordTooShort"
    static let validation_passwordWeak = "validation.passwordWeak"
    static let validation_usernameInvalid = "validation.usernameInvalid"
    static let validation_fieldRequired = "validation.fieldRequired"
    static let error_usernameUpdateFailed = "error.usernameUpdateFailed"
    static let error_profileSaveFailed = "error.profileSaveFailed"
    static let error_registrationFailed = "error.registrationFailed"
    static let error_tokenRefreshFailed = "error.tokenRefreshFailed"
    static let error_passwordResetEmailFailed = "error.passwordResetEmailFailed"
    static let error_passwordUpdateFailed = "error.passwordUpdateFailed"
    static let error_passwordChangeFailed = "error.passwordChangeFailed"
    static let error_purchaseUnverified = "error.purchaseUnverified"
    static let error_preferencesLoadFailed = "error.preferencesLoadFailed"
    static let error_appleAccountExists = "error.appleAccountExists"
    static let recipe_loading = "recipe.loading"
    static let error_moderationFailed = "error.moderationFailed"
    static let error_uploadLimitReached = "error.uploadLimitReached"
    static let error_serverRetry = "error.serverRetry"
    static let error_uploadRetry = "error.uploadRetry"
    static let error_sessionExpired = "error.sessionExpired"
    static let error_recipeLoadIncomplete = "error.recipeLoadIncomplete"
    static let error_reportFailed = "error.reportFailed"
    static let error_aiChatRestricted = "error.aiChatRestricted"
    static let error_aiRecipeRestricted = "error.aiRecipeRestricted"
    static let error_aiAnalysisRestricted = "error.aiAnalysisRestricted"
    static let paywall_unlimitedMembersOnly = "paywall.unlimitedMembersOnly"
    static let creator_aiGeneratorTitle = "creator.aiGeneratorTitle"
    static let nav_aiCooking = "nav.aiCooking"
    static let chat_messageEllipsis = "chat.messageEllipsis"
    static let timer_running = "timer.running"
    static let timer_reset = "timer.reset"
    static let paywall_percentOff = "paywall.percentOff"
    static let mealplan_tabRecipe = "mealplan.tabRecipe"
    static let mealplan_tabPlan = "mealplan.tabPlan"
    static let mealplan_bookRecipes = "mealplan.bookRecipes"
    static let mealplan_bookPlans = "mealplan.bookPlans"
    ...
    static let mealplan_modeRange = "mealplan.modeRange"
    static let mealplan_modeExact = "mealplan.modeExact"
    static let mealplan_kcal = "mealplan.kcal"
    static let mealplan_protein = "mealplan.protein"
    static let mealplan_fat = "mealplan.fat"
    static let mealplan_carbs = "mealplan.carbs"
    static let mealplan_macroTotal = "mealplan.macroTotal"
    static let mealplan_macrosMustBe100 = "mealplan.macrosMustBe100"
    static let mealplan_quotaHint = "mealplan.quotaHint"
    static let mealplan_generate = "mealplan.generate"
    static let mealplan_resultHint = "mealplan.resultHint"
    static let mealplan_save = "mealplan.save"
    static let mealplan_creatingRecipe = "mealplan.creatingRecipe"
    static let mealplan_recipeFailed = "mealplan.recipeFailed"
    static let mealplan_retry = "mealplan.retry"
    static let mealplan_saveNeedsRecipes = "mealplan.saveNeedsRecipes"
    static let mealplan_emptyTitle = "mealplan.emptyTitle"
    static let mealplan_emptyBody = "mealplan.emptyBody"
    static let mealplan_createCta = "mealplan.createCta"
    static let mealplan_cardSubtitle = "mealplan.cardSubtitle"
    static let mealplan_deleteTitle = "mealplan.deleteTitle"
    static let mealplan_deleteBody = "mealplan.deleteBody"
    static let mealplan_slot_breakfast = "mealplan.slot.breakfast"
    static let mealplan_slot_lunch = "mealplan.slot.lunch"
    static let mealplan_slot_dinner = "mealplan.slot.dinner"
    static let mealplan_slot_morningSnack = "mealplan.slot.morningSnack"
    static let mealplan_slot_afternoonSnack = "mealplan.slot.afternoonSnack"
    static let mealplan_slot_eveningSnack = "mealplan.slot.eveningSnack"
    static let mealplan_slot_snack = "mealplan.slot.snack"
    static let mealplan_slot_preWorkout = "mealplan.slot.preWorkout"
    static let mealplan_slot_intraWorkout = "mealplan.slot.intraWorkout"
    static let mealplan_slot_postWorkout = "mealplan.slot.postWorkout"
    static let mealplan_slot_brunch = "mealplan.slot.brunch"
    static let mealplan_slot_proteinSnack = "mealplan.slot.proteinSnack"
    static let mealplan_slot_dessert = "mealplan.slot.dessert"
