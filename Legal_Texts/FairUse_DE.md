...
- **100 Anfragen pro Tag** (00:00 - 23:59 Uhr)
- Maximale Anzahl KI-Anfragen pro Tag

### Monatliches Limit

- **1.000 Anfragen pro Monat**
- Maximale Anzahl KI-Anfragen pro Kalendermonat

**Hinweis:** Diese Limits gelten pro Benutzerkonto. Ein Zurücksetzen erfolgt automatisch täglich bzw. monatlich.

---

## 4. Was zählt als Anfrage?

**Als Anfrage gilt:**

- Jede KI-Rezeptgenerierung
- Jede Chat-Nachricht an Culina
- Jede Rezeptanpassung oder -analyse

**Nicht als Anfrage zählt:**
...
**Beispiel: Durchschnittliche Nutzung**

- 3-5 Rezeptgenerierungen pro Tag = 15-25 Anfragen/Tag
- 10-15 Chat-Nachrichten = 10-15 Anfragen/Tag
- **Gesamt: ~20-40 Anfragen/Tag**

**Erfolg:** Die meisten Nutzer bleiben deutlich unter 50 Anfragen pro Tag und 500 Anfragen pro Monat.
...
1. KI-Funktionen werden temporär deaktiviert
2. Sie erhalten eine Benachrichtigung in der App
3. Alle anderen Funktionen bleiben verfügbar
4. Nach Zurücksetzung (täglich/monatlich) steht die volle Funktionalität wieder zur Verfügung
...
- **Zählmethode:** Server-seitig über API-Gateway
- **Zurücksetzung (täglich):** Automatisch um 00:00 Uhr (UTC)
- **Zurücksetzung (monatlich):** Automatisch am 1. des Monats
- **Transparenz:** Aktueller Verbrauch in den App-Einstellungen einsehbar

---

## 9. Anpassung der Limits
...
1. Senden Sie eine E-Mail an support@culinaai.com
2. Beschreiben Sie Ihren Anwendungsfall und geschätzten Bedarf
3. Unser Support-Team prüft Ihre Anfrage individuell
4. Bei Genehmigung werden Ihre Limits angepasst

**Kontakt:** support@culinaai.com  
**Betreff:** Anfrage: Höhere KI-Nutzungsgrenzen
