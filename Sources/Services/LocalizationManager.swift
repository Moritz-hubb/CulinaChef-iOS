...
class LocalizationManager: ObservableObject {
    ...
    private func loadTranslations() {
        ...
        guard let validPath = path,
            ...
            print("⚠️ Failed to load translations for \(currentLanguage) in any location")
        ...
        translations = json
        print("✅ Loaded \(translations.count) translations for \(currentLanguage) from: \(validPath)")
    }
    ...
    private func loadFallbackTranslations() {
        ...
        guard let validFallbackPath = fallbackPath,
            ...
            print("❌ Failed to load fallback translations for \(fallbackLanguage)")
            return
        }
        
        translations = fallbackJson
        print("✅ Loaded fallback translations (\(translations.count) keys) from: \(validFallbackPath)")
    }
